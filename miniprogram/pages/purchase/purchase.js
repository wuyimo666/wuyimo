Page({
    ...
    loadData: function() {
        ...
        const purchaseRecords = records.filter(r => r.type === 'purchase').sort((a, b) => b.date.localeCompare(a.date));
    ...
    saveRecord: function() {
        ...
        this.setData({
            ...
            totalAmount: 0,
            note: '',
            records: [...records.filter(r => r.type === 'purchase').sort((a, b) => b.date.localeCompare(a.date)).slice(0, 50)]
        });
    }
});
